...
describe('Product Model', function () {
    ...
    it('should return the correct product by category', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.showByCategory('Test category')];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual([{
                            id: 1,
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.deleteProduct('1')];
                case 1:
                    temp = _a.sent();
