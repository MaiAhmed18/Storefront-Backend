        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable show product ".concat(id, ": ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable to create product (".concat(p.name, "): ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.showByCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable show products by category ".concat(category, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
