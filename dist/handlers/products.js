...
var productRoutes = function (app) {
    ...
    app.delete('/products/:id', verifyToken_1.default, deleteProduct);
};
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, productStore.show(_req.params.id)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [2 /*return*/];
...
var showByCategory = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, productStore.showByCategory(_req.params.category)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [2 /*return*/];
...
var deleteProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productStore.deleteProduct(_req.params.id)];
            case 1:
                product = _a.sent();
                res.status(200).json("Product ".concat(_req.params.id, " Was Deleted"));
                return [3 /*break*/, 3];
            case 2:
                e_1 = _a.sent();
