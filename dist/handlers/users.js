...
var userRoutes = function (app) {
    ...
    app.delete('/users/:id', verifyToken_1.default, deleteUser);
};
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userStore.show(_req.params.id)];
            case 1:
                user = _a.sent();
...
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userStore.deleteUser(req.params.id)];
            case 1:
                deletedUser = _a.sent();
                res.status(200).json("User ".concat(req.params.id, " was Deleted"));
                return [3 /*break*/, 3];
            case 2:
                e_1 = _a.sent();
